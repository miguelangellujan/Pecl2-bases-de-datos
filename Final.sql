...
create table if not exists collision_person_def(
    ...
    Constraint collision_person_def FOREIGN KEY (vehicle_id) references vehicles_def,
    Constraint collision_person_def FOREIGN KEY (accident_id) references collision_crashes_def,
    Constraint collision_person_def PRIMARY KEY (collision_person_id)
);
create table if not exists collision_vehicles_def(
    ...
    CONTRIBUTING_FACTOR_1 VARCHAR(255),
    CONTRIBUTING_FACTOR_2 VARCHAR(255),
    Constraint collision_vehicles_def PRIMARY KEY (collision_vehicle_id),
    Constraint collision_vehicles_def FOREIGN KEY (accident_id) references collision_crashes_def,
    Constraint collision_vehicles_def FOREIGN KEY (vehicle_id) references vehicles_def
)